...
const char HTTP_SAVED[] PROGMEM           = "<div>Credentials Saved<br />Trying to connect MyGasValve to network.<br />If it fails reconnect to MyGasValve to try again</div>";
